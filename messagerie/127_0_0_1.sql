...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 30 mai 2024 à 09:06
...
--
-- Base de données : `ecoline`
--
CREATE DATABASE IF NOT EXISTS `ecoline` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ecoline`;
...
CREATE TABLE `message` (
  ...
  `message_media` mediumblob DEFAULT NULL,
  `destinataire_id` int(8) NOT NULL,
...
INSERT INTO `message` (`user_id`, `message_text`, `message_media`, `destinataire_id`, `message_content`) VALUES
(0, 'test', NULL, 12345678, ''),
(0, 'test', NULL, 12345678, ''),
(0, 'test', NULL, 12345678, ''),
(0, 'test', NULL, 12345678, ''),
(0, 'test', NULL, 12345678, ''),
...
(0, 'test', NULL, 12345678, ''),
(0, 'test', NULL, 12345678, ''),
(0, 'frfrfrfrfr', NULL, 12333333, 'frrff'),
(0, 'frfrfrfrfr', NULL, 12333333, 'frrff'),
(0, 'frfrfrfrfr', NULL, 12333333, 'frrff'),
(0, 'OUI ?', NULL, 0, 'Test BDD ');
--
...
('root', '[{\"db\":\"ecoline\",\"table\":\"message\"},{\"db\":\"test\",\"table\":\"helloworld\"},{\"db\":\"test\",\"table\":\"HelloWorld\"}]');
...
('root', 'ecoline', 'message', '[]', '2024-05-27 08:47:11');
...
('root', '2024-05-28 09:14:54', '{\"Console\\/Mode\":\"show\",\"NavigationDisplayLogo\":false,\"Server\\/hide_db\":\"\",\"Server\\/only_db\":\"\",\"ThemeDefault\":\"pmahomme\",\"lang\":\"fr\"}');
...
INSERT INTO `helloworld` (`Text`, `firstname`, `lastname`, `message_text`) VALUES
...
('', 'test', 'oui ? ', ''),
('', 'test', 'oui ? ', 'hein@gmail.com'),
('', 'message_text', 'message_text', 'message_textzzz@gmail.com'),
('', 'message_text', 'message_text', 'message_textzzz@gmail.com'),
('', 'message_text', 'message_text', 'message_textzzz@gmail.com'),
('', 'message_text', 'message_text', 'message_textzzz@gmail.com'),
